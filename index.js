...
raisedCard.innerHTML = `<p>$${totalPledge.toLocaleString('en-US')}</p>`
...
const displayStr = `A total of $${totalPledge.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently, ${numUnfunded} ${numUnfunded > 1 ? "games" : 
"game"} remains unfunded. We need your help to fund ${numUnfunded > 1 ? "these" : 
"this"} amazing ${numUnfunded > 1 ? "games" : 
"game"}!`
...
let secondTop = document.createElement('p');
